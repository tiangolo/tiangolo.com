...
You can use environment variables to configure applications and tools without putting those values directly in your code.
...
If you don't have Python installed yet, the simplest option is to use [`uv`](https://docs.astral.sh/uv/guides/install-python/). It can install and manage Python versions for you, for example with `uv python install`.
...
For example, you will need this information in the guide about [Virtual Environments](virtual-environments.md).
