...
These are the tasks that can be performed to manage the repositories in the FastAPI organization in GitHub.

/// tip

This section is useful only to a handful of people, team members with permissions to manage the repositories in the FastAPI organization. You can probably skip it. 😉

///

...so, you are a [member of the FastAPI team](../github-fastapi.md#team)? Wow, you are so cool! 😎

There are some tasks that only you (as part of the team) can perform. 🙌
...
* `docs`: Docs
    * Changes in docs. This includes updating the docs, fixing typos.
* `lang-all`: Translations
    * For example, for LLM prompt updates.
* `internal`: Internal
...
There are some additional tasks specific to the FastAPI repo.

### Merge Translation PRs

Translations for the FastAPI docs are generated automatically with LLMs and scripts.
